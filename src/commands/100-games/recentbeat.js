...
const { getUserRegistration, getRecentBeatenGameEntry, getBeatenGameCount, getPlanningGameCount, getPlayingGameCount } = require('../../helpers/database');
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const loggedGameEntry = await getRecentBeatenGameEntry(userDatabaseEntry);
